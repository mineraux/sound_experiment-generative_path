    ...
    _load(src, callback) {
        ...
        if (src) {
            ...
            request.onprogress = (e) => {
                ...
                this.path = document.querySelector('.path1')
                this.path.style.strokeDashoffset = 260 - (260 * this._progress)

                this.path2 = document.querySelector('.path2')
                this.path2.style.strokeDashoffset = 780 - (780 * this._progress)

                this.path3 = document.querySelector('.path3')
                this.path3.style.strokeDashoffset = 860 - (860 * this._progress)
            };
    		request.onload = () => {
